...
public class RegularMultOrDivOperatorImpl extends ASTWrapperPsiElement implements RegularMultOrDivOperator {

  public RegularMultOrDivOperatorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RegularVisitor visitor) {
    visitor.visitMultOrDivOperator(this);
  }
