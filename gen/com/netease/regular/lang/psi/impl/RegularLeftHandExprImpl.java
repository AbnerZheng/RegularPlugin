...
public class RegularLeftHandExprImpl extends ASTWrapperPsiElement implements RegularLeftHandExpr {

  public RegularLeftHandExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RegularVisitor visitor) {
    visitor.visitLeftHandExpr(this);
  }
  ...
  @Override
  @Nullable
  public RegularCallExpr getCallExpr() {
    return findChildByClass(RegularCallExpr.class);
  }
