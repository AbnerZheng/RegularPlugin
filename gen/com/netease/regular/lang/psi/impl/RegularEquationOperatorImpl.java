...
public class RegularEquationOperatorImpl extends ASTWrapperPsiElement implements RegularEquationOperator {

  public RegularEquationOperatorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RegularVisitor visitor) {
    visitor.visitEquationOperator(this);
  }
