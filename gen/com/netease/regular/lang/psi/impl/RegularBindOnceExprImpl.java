...
public class RegularBindOnceExprImpl extends ASTWrapperPsiElement implements RegularBindOnceExpr {

  public RegularBindOnceExprImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RegularVisitor visitor) {
    visitor.visitBindOnceExpr(this);
  }
  ...
  public RegularFilter getFilter() {
    return findNotNullChildByClass(RegularFilter.class);
  }
