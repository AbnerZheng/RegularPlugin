...
public class RegularAddorsubOperatorImpl extends ASTWrapperPsiElement implements RegularAddorsubOperator {

  public RegularAddorsubOperatorImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RegularVisitor visitor) {
    visitor.visitAddorsubOperator(this);
  }
